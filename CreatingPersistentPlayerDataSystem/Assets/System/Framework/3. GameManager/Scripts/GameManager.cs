...
public class GameManager : Singleton<GameManager>
{
    ...
    public void SetDefaultLevel(string levelName)
    {
    ...
    void OnLoadOperationComplete(AsyncOperation ao)
    {
        if (_loadOperations.Contains(ao))
        {
            ...
            if (_loadOperations.Count == 0)
            {
                ...
                SceneManager.SetActiveScene(SceneManager.GetSceneByName(_currentLevelName)); // update lighting
            }
        }
    ...
    public void RestartGame()
    {
        ...
        {
            var c = g.GetComponentInChildren<NPCController>();
            if (c != null)
            {
                c.CancelInvoke();
                c.enabled = false;
