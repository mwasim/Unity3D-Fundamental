...
public class Spell : AttackDefinition 
{
    ...
    public void Cast(GameObject Caster, Vector3 HotSpot, Vector3 Target, int Layer) //layer's beneift, for example, enemies projectiles will not collide with other enemies
    {
